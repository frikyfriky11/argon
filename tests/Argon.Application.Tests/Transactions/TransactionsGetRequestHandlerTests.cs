...
[TestFixture]
public class TransactionsGetRequestHandlerTests
{
  [SetUp]
  public void SetUp()
  {
    ...
    _sut = new TransactionsGetRequestHandler(_dbContext, _mapper);
  }

  private TransactionsGetRequestHandler _sut = null!;
