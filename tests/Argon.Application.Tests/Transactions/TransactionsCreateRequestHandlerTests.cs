...
[TestFixture]
public class TransactionsCreateRequestValidatorTests
{
  [SetUp]
  public void SetUp()
  {
    ...
    _sut = new TransactionsCreateRequestValidator(_dbContext);
  }

  private TransactionsCreateRequestValidator _sut = null!;
...
[TestFixture]
public class TransactionsCreateRequestHandlerTests
{
  [SetUp]
  public void SetUp()
  {
    ...
    _sut = new TransactionsCreateRequestHandler(_dbContext, _mapper);
  }

  private TransactionsCreateRequestHandler _sut = null!;
  private IApplicationDbContext _dbContext = null!;
