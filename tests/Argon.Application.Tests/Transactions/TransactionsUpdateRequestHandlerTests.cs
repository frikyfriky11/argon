...
[TestFixture]
public class TransactionsUpdateRequestValidatorTests
{
  [SetUp]
  public void SetUp()
  {
    ...
    _sut = new TransactionsUpdateRequestValidator(_dbContext);
  }

  private TransactionsUpdateRequestValidator _sut = null!;
...
[TestFixture]
public class TransactionsUpdateRequestHandlerTests
{
  [SetUp]
  public void SetUp()
  {
    ...
    _sut = new TransactionsUpdateRequestHandler(_dbContext, _mapper);
  }

  private TransactionsUpdateRequestHandler _sut = null!;
  private IApplicationDbContext _dbContext = null!;
