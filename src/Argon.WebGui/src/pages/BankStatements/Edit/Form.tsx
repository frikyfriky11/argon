...
export type FormProps = {
  account: IAccountsGetResponse;
  onSubmit: SubmitHandler<IAccountsGetResponse>;
  isSaving: boolean;
};

export default function Form({ account, onSubmit, isSaving }: FormProps) {
  const form = useForm<IAccountsGetResponse>({
